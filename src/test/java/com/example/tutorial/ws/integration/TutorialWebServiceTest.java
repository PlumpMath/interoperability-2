...
import org.wtf.interoperability.ws.vo.RequestStructure;
...
public class TutorialWebServiceTest extends AbstractTestNGSpringContextTests
{
	...
	private TutorialRequest getRequest() throws URISyntaxException {
		...
		structure.getTag().add(newTag("tag:vork:339:#1", "Some Value 1"));
		structure.getTag().add(newTag("tag:vork:339:#2", "Some Value 2"));
		structure.getTag().add(newTag("tag:vork:339:#3", "Some Value 3"));
		structure.getTag().add(newTag("tag:vork:339:#4", "Some Value 4"));
